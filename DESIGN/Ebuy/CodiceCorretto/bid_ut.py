...
class bid_ut:
    '''Link a responsabilità doppia con gestione asimettrica verso Bid'''
    class _link:
        _bid: Bid 
        ...
        def __init__(self, b: Bid, up: UtentePrivato) -> None:
            self._bid: Bid = b 
            self._utentePrivato: UtentePrivato = up
        ...
        def __repr__(self):
            return f"bid_ut(bid={self.bid()}, utente_privato(utente={self.utente_privato()}))"
